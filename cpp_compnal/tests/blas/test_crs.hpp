...
TEST(CRS, Constructors) {
   ...
   EXPECT_NO_THROW(blas::CRS<double>(std::vector<std::vector<std::int32_t>>{{1, 2, 3}, {-1, -2}}));
   EXPECT_NO_THROW(blas::CRS<std::int32_t>());
   EXPECT_NO_THROW(blas::CRS<std::int32_t>(3, 4));
   EXPECT_NO_THROW(blas::CRS<std::int32_t>(3, 4, blas::CRSTag::FERMION));
   EXPECT_NO_THROW(blas::CRS<std::int32_t>({{1, 2}, {3}, {-1}}));
   EXPECT_NO_THROW(blas::CRS<std::int32_t>({{1, 2}, {3}, {-1}}, blas::CRSTag::FERMION));
   EXPECT_NO_THROW(blas::CRS<std::int32_t>(std::vector<std::vector<std::int32_t>>{{1, 2, 3}, {-1, -2}}));
   EXPECT_EQ(blas::CRS<std::int32_t>({{0, 0, 0}, {0, 0, 0}, {0, 0, 0}}), blas::CRS<std::int32_t>(3, 3));
}

TEST(CRS, Free) {
   blas::CRS<std::int32_t> m({{1, 2}, {3}, {-1}}, blas::CRSTag::FERMION);
   m.name = "Matrix";
   m.Free();
   EXPECT_EQ(m, blas::CRS<std::int32_t>());
}

TEST(CRS, Assign) {
   blas::CRS<std::int32_t> m_int({{1, 2}, {3}, {-1}}, blas::CRSTag::BOSON);
...
TEST(CRS, MultiplyByScalar) {
   ...
   blas::CRS<std::int32_t> m_int({{1, 3}, {3}, {-1}});
   m_int.MultiplyByScalar(2);
   EXPECT_EQ(m_int, blas::CRS<std::int32_t>({{2, 6}, {6}, {-2}}));
}

TEST(CRS, SortCol) {
   blas::CRS<std::int32_t> m_d(3, 3);
   m_d.col.resize(8);
   m_d.val.resize(8);
   m_d.row[1] = 2;
   m_d.row[2] = 5;
   ...
   m_d.val[6] = 5;
   m_d.val[7] = 6;
   EXPECT_FALSE(m_d == blas::CRS<std::int32_t>({{0, 1, 2}, {2, 3, 4}, {5, 6, 7}}));
   m_d.SortCol();
   EXPECT_TRUE(m_d == blas::CRS<std::int32_t>({{0, 1, 2}, {2, 3, 4}, {5, 6, 7}}));
}
...
TEST(CRS, CompoundAssignmentOperators) {
   blas::CRS<std::int32_t> m_d_1({{+1, +2}, {+2, +1}});
   blas::CRS<std::int32_t> m_d_2({{-3, +1}, {-2, -2}});
   blas::CRS<std::int32_t> m_d_3 = m_d_1 + m_d_2;
   m_d_1 += m_d_2;
   EXPECT_EQ(m_d_1, m_d_3);
   m_d_1 -= m_d_2;
   EXPECT_EQ(m_d_1, m_d_3 - m_d_2);
   m_d_1 *= m_d_2;
   EXPECT_EQ(m_d_1, blas::CRS<std::int32_t>({{+1, +2}, {+2, +1}}) * m_d_2);
}

TEST(CRS, CalculateMatrixMatrixSum) {
   blas::CRS<std::int32_t> m_1(2, 2);
   blas::CRS<std::int32_t> m_2(2, 2);
   blas::CRS<std::int32_t> m_3(2, 2);
   ...
   EXPECT_EQ(m_3, blas::CRS<std::int32_t>(2, 2, blas::CRSTag::FERMION));

   m_1.tag = blas::CRSTag::FERMION;
   m_2.tag = blas::CRSTag::BOSON;
   m_3 = blas::CalculateMatrixMatrixSum(1, m_1, 1, m_2);
   EXPECT_EQ(m_3, blas::CRS<std::int32_t>(2, 2, blas::CRSTag::MIX));
   ...
   m_2.tag = blas::CRSTag::BOSON;
   m_3 = blas::CalculateMatrixMatrixSum(1, m_1, 1, m_2);
   EXPECT_EQ(m_3, blas::CRS<std::int32_t>(2, 2, blas::CRSTag::BOSON));
   ...
   m_2.tag = blas::CRSTag::NONE;
   m_3 = blas::CalculateMatrixMatrixSum(1, m_1, 1, m_2);
   EXPECT_EQ(m_3, blas::CRS<std::int32_t>(2, 2, blas::CRSTag::NONE));

   // Check Sum
   m_1 = blas::CRS<std::int32_t>({{1, 2}, {3, 4}}, blas::CRSTag::NONE);
   m_2 = blas::CRS<std::int32_t>({{5, 6}, {7, 8}}, blas::CRSTag::NONE);
   m_3 = blas::CalculateMatrixMatrixSum(2, m_1, 3, m_2);
   EXPECT_EQ(m_3, blas::CRS<std::int32_t>({{2 + 15, 4 + 18}, {6 + 21, 8 + 24}}));

   m_1 = blas::CRS<std::int32_t>({{0, 0}, {0, 0}}, blas::CRSTag::NONE);
   m_2 = blas::CRS<std::int32_t>({{1, 2}, {3, 4}}, blas::CRSTag::NONE);
   m_3 = blas::CalculateMatrixMatrixSum(2, m_1, 3, m_2);
   EXPECT_EQ(m_3, blas::CRS<std::int32_t>({{3, 6}, {9, 12}}));

   m_1 = blas::CRS<std::int32_t>({{1, 2}, {3, 4}}, blas::CRSTag::NONE);
   m_2 = blas::CRS<std::int32_t>({{0, 0}, {0, 0}}, blas::CRSTag::NONE);
   m_3 = blas::CalculateMatrixMatrixSum(2, m_1, 3, m_2);
   EXPECT_EQ(m_3, blas::CRS<std::int32_t>({{2, 4}, {6, 8}}));

   m_1 = blas::CRS<std::int32_t>({{0, 0}, {5, 0}}, blas::CRSTag::NONE);
   m_2 = blas::CRS<std::int32_t>({{1, 2}, {3, 4}}, blas::CRSTag::NONE);
   m_3 = blas::CalculateMatrixMatrixSum(2, m_1, 3, m_2);
   EXPECT_EQ(m_3, blas::CRS<std::int32_t>({{3, 6}, {9 + 10, 12}}));

   m_1 = blas::CRS<std::int32_t>({{1, 2}, {3, 4}}, blas::CRSTag::NONE);
   m_2 = blas::CRS<std::int32_t>({{0, 5}, {0, 0}}, blas::CRSTag::NONE);
   m_3 = blas::CalculateMatrixMatrixSum(2, m_1, 3, m_2);
   EXPECT_EQ(m_3, blas::CRS<std::int32_t>({{2, 4 + 15}, {6, 8}}));
...
TEST(CRS, CalculateMatrixMatrixProduct) {
   ...
   // Check Prod
   m_1 = blas::CRS<std::int32_t>({{1, 2, 3}, {4, 5, 6}}, blas::CRSTag::NONE);
   m_2 = blas::CRS<std::int32_t>({{7, 8}, {9, 10}, {11, 12}}, blas::CRSTag::NONE);
   m_3 = blas::CalculateMatrixMatrixProduct(2, m_1, m_2);
   EXPECT_EQ(m_3, blas::CRS<std::int32_t>({{58 * 2, 64 * 2}, {139 * 2, 154 * 2}}));

   m_1 = blas::CRS<std::int32_t>({{1, 2, 0}, {4, 0, 0}}, blas::CRSTag::NONE);
   m_2 = blas::CRS<std::int32_t>({{7, 8}, {9, 10}, {11, 12}}, blas::CRSTag::NONE);
   m_3 = blas::CalculateMatrixMatrixProduct(2, m_1, m_2);
   EXPECT_EQ(m_3, blas::CRS<std::int32_t>({{25 * 2, 28 * 2}, {28 * 2, 32 * 2}}));

   m_1 = blas::CRS<std::int32_t>({{1, 2, 3}, {4, 5, 6}}, blas::CRSTag::NONE);
   m_2 = blas::CRS<std::int32_t>({{7, 8}, {0, 0}, {11, 0}}, blas::CRSTag::NONE);
   m_3 = blas::CalculateMatrixMatrixProduct(2, m_1, m_2);
   EXPECT_EQ(m_3, blas::CRS<std::int32_t>({{40 * 2, 8 * 2}, {94 * 2, 32 * 2}}));

   m_1 = blas::CRS<std::int32_t>({{0, 0, 0}, {0, 0, 0}}, blas::CRSTag::NONE);
   m_2 = blas::CRS<std::int32_t>({{7, 8}, {9, 10}, {11, 12}}, blas::CRSTag::NONE);
   m_3 = blas::CalculateMatrixMatrixProduct(2, m_1, m_2);
   EXPECT_EQ(m_3, blas::CRS<std::int32_t>({{0, 0}, {0, 0}}));

   m_1 = blas::CRS<std::int32_t>({{1, 2, 3}, {4, 5, 6}}, blas::CRSTag::NONE);
   m_2 = blas::CRS<std::int32_t>({{0, 0}, {0, 0}, {0, 0}}, blas::CRSTag::NONE);
   m_3 = blas::CalculateMatrixMatrixProduct(2, m_1, m_2);
   EXPECT_EQ(m_3, blas::CRS<std::int32_t>({{0, 0}, {0, 0}}));
...
TEST(CRS, CalculateScalarMatrixProduct) {
   blas::CRS<std::int32_t> m_1({{1, 2}, {3, 4}});
   auto m_2 = blas::CalculateScalarMatrixProduct(2, m_1);
   EXPECT_EQ(m_2, blas::CRS<std::int32_t>({{2, 4}, {6, 8}}));

   m_2 = blas::CalculateScalarMatrixProduct(0, m_1);
   EXPECT_EQ(m_2, blas::CRS<std::int32_t>({{0, 0}, {0, 0}}));
}

TEST(CRS, CalculateTransposedMatrix) {
   blas::CRS<std::int32_t> m_1({{1, 2, 3}, {4, 5, 6}}, blas::CRSTag::NONE);
   auto m_2 = blas::GenerateTransposedMatrix(m_1);
   EXPECT_EQ(m_2, blas::CRS<std::int32_t>({{1, 4}, {2, 5}, {3, 6}}));
}
...
TEST(CRS, Addition) {
   ...
   expect_crs_eq(CRS<long double>({{1.3L}}) + CRS<std::int32_t>({{1}}), CRS<long double>({{2.3L}}), LDBL_EPSILON, __LINE__);
   ...
   expect_crs_eq(CRS<double>({{1.3}}) + CRS<std::int32_t>({{1}}), CRS<double>({{2.3}}), DBL_EPSILON, __LINE__);
   ...
   expect_crs_eq(CRS<float>({{1.3F}}) + CRS<std::int32_t>({{1}}), CRS<float>({{2.3F}}), FLT_EPSILON, __LINE__);
   ...
   expect_crs_eq(CRS<long long>({{1LL}}) + CRS<std::int32_t>({{1}}), CRS<std::int32_t>({{2LL}}), LDBL_EPSILON, __LINE__);
   ...
   expect_crs_eq(CRS<long>({{1L}}) + CRS<std::int32_t>({{1}}), CRS<std::int32_t>({{2LL}}), LDBL_EPSILON, __LINE__);
   ...
   expect_crs_eq(CRS<std::int32_t>({{1}}) + CRS<long double>({{1.4L}}), CRS<long double>({{2.4L}}), LDBL_EPSILON, __LINE__);
   expect_crs_eq(CRS<std::int32_t>({{1}}) + CRS<double>({{1.4}}), CRS<double>({{2.4}}), DBL_EPSILON, __LINE__);
   expect_crs_eq(CRS<std::int32_t>({{1}}) + CRS<float>({{1.4F}}), CRS<float>({{2.4F}}), FLT_EPSILON, __LINE__);
   expect_crs_eq(CRS<std::int32_t>({{1}}) + CRS<long long>({{1LL}}), CRS<long long>({{2LL}}), LDBL_EPSILON, __LINE__);
   expect_crs_eq(CRS<std::int32_t>({{1}}) + CRS<long>({{1L}}), CRS<long>({{2LL}}), LDBL_EPSILON, __LINE__);
   expect_crs_eq(CRS<std::int32_t>({{1}}) + CRS<std::int32_t>({{1}}), CRS<std::int32_t>({{2LL}}), LDBL_EPSILON, __LINE__);
   expect_crs_eq(CRS<std::int32_t>({{1}}) + CRS<short>({{1}}), CRS<short>({{2LL}}), LDBL_EPSILON, __LINE__);
   expect_crs_eq(CRS<std::int32_t>({{1}}) + CRS<char>({{1}}), CRS<char>({{2LL}}), LDBL_EPSILON, __LINE__);
   ...
   expect_crs_eq(CRS<short>({{1}}) + CRS<std::int32_t>({{1}}), CRS<std::int32_t>({{2LL}}), LDBL_EPSILON, __LINE__);
   ...
   expect_crs_eq(CRS<char>({{1}}) + CRS<std::int32_t>({{1}}), CRS<std::int32_t>({{2LL}}), LDBL_EPSILON, __LINE__);
...
TEST(CRS, Subtraction) {
   ...
   expect_crs_eq(CRS<long double>({{1.3L}}) - CRS<std::int32_t>({{1}}), CRS<long double>({{+0.3L}}), LDBL_EPSILON, __LINE__);
   ...
   expect_crs_eq(CRS<double>({{1.3}}) - CRS<std::int32_t>({{1}}), CRS<double>({{+0.3}}), DBL_EPSILON, __LINE__);
   ...
   expect_crs_eq(CRS<float>({{1.3F}}) - CRS<std::int32_t>({{1}}), CRS<float>({{+0.3F}}), FLT_EPSILON, __LINE__);
   ...
   expect_crs_eq(CRS<long long>({{1LL}}) - CRS<std::int32_t>({{2}}), CRS<std::int32_t>({{-1LL}}), LDBL_EPSILON, __LINE__);
   ...
   expect_crs_eq(CRS<long>({{1L}}) - CRS<std::int32_t>({{2}}), CRS<std::int32_t>({{-1LL}}), LDBL_EPSILON, __LINE__);
   ...
   expect_crs_eq(CRS<std::int32_t>({{1}}) - CRS<long double>({{1.4L}}), CRS<long double>({{-0.4L}}), LDBL_EPSILON, __LINE__);
   expect_crs_eq(CRS<std::int32_t>({{1}}) - CRS<double>({{1.4}}), CRS<double>({{-0.4}}), DBL_EPSILON, __LINE__);
   expect_crs_eq(CRS<std::int32_t>({{1}}) - CRS<float>({{1.4F}}), CRS<float>({{-0.4F}}), FLT_EPSILON, __LINE__);
   expect_crs_eq(CRS<std::int32_t>({{1}}) - CRS<long long>({{2LL}}), CRS<long long>({{-1LL}}), LDBL_EPSILON, __LINE__);
   expect_crs_eq(CRS<std::int32_t>({{1}}) - CRS<long>({{2L}}), CRS<long>({{-1LL}}), LDBL_EPSILON, __LINE__);
   expect_crs_eq(CRS<std::int32_t>({{1}}) - CRS<std::int32_t>({{2}}), CRS<std::int32_t>({{-1LL}}), LDBL_EPSILON, __LINE__);
   expect_crs_eq(CRS<std::int32_t>({{1}}) - CRS<short>({{2}}), CRS<short>({{-1LL}}), LDBL_EPSILON, __LINE__);
   expect_crs_eq(CRS<std::int32_t>({{1}}) - CRS<char>({{2}}), CRS<char>({{-1LL}}), LDBL_EPSILON, __LINE__);
   ...
   expect_crs_eq(CRS<short>({{1}}) - CRS<std::int32_t>({{2}}), CRS<std::int32_t>({{-1LL}}), LDBL_EPSILON, __LINE__);
   ...
   expect_crs_eq(CRS<char>({{1}}) - CRS<std::int32_t>({{2}}), CRS<std::int32_t>({{-1LL}}), LDBL_EPSILON, __LINE__);
...
TEST(CRS, MultiplicationMatrixMatrix) {
   ...
   expect_crs_eq(CRS<long double>({{1.3L}}) * CRS<std::int32_t>({{2}}), CRS<long double>({{2.6L}}), LDBL_EPSILON, __LINE__);
   ...
   expect_crs_eq(CRS<double>({{1.3}}) * CRS<std::int32_t>({{2}}), CRS<double>({{2.6}}), DBL_EPSILON, __LINE__);
   ...
   expect_crs_eq(CRS<float>({{1.3F}}) * CRS<std::int32_t>({{2}}), CRS<float>({{2.6F}}), FLT_EPSILON, __LINE__);
   ...
   expect_crs_eq(CRS<long long>({{1LL}}) * CRS<std::int32_t>({{2}}), CRS<long long>({{2LL}}), LDBL_EPSILON, __LINE__);
   ...
   expect_crs_eq(CRS<long>({{1L}}) * CRS<std::int32_t>({{2}}), CRS<std::int32_t>({{2LL}}), LDBL_EPSILON, __LINE__);
   ...
   expect_crs_eq(CRS<std::int32_t>({{1}}) * CRS<long double>({{1.4L}}), CRS<long double>({{1.4L}}), LDBL_EPSILON, __LINE__);
   expect_crs_eq(CRS<std::int32_t>({{1}}) * CRS<double>({{1.4}}), CRS<double>({{1.4}}), DBL_EPSILON, __LINE__);
   expect_crs_eq(CRS<std::int32_t>({{1}}) * CRS<float>({{1.4F}}), CRS<float>({{1.4F}}), FLT_EPSILON, __LINE__);
   expect_crs_eq(CRS<std::int32_t>({{1}}) * CRS<long long>({{2LL}}), CRS<long long>({{2LL}}), LDBL_EPSILON, __LINE__);
   expect_crs_eq(CRS<std::int32_t>({{1}}) * CRS<long>({{2L}}), CRS<long>({{2LL}}), LDBL_EPSILON, __LINE__);
   expect_crs_eq(CRS<std::int32_t>({{1}}) * CRS<std::int32_t>({{2}}), CRS<std::int32_t>({{2LL}}), LDBL_EPSILON, __LINE__);
   expect_crs_eq(CRS<std::int32_t>({{1}}) * CRS<short>({{2}}), CRS<short>({{2LL}}), LDBL_EPSILON, __LINE__);
   expect_crs_eq(CRS<std::int32_t>({{1}}) * CRS<char>({{2}}), CRS<char>({{2LL}}), LDBL_EPSILON, __LINE__);
   ...
   expect_crs_eq(CRS<short>({{1}}) * CRS<std::int32_t>({{2}}), CRS<std::int32_t>({{2LL}}), LDBL_EPSILON, __LINE__);
   ...
   expect_crs_eq(CRS<char>({{1}}) * CRS<std::int32_t>({{2}}), CRS<std::int32_t>({{2LL}}), LDBL_EPSILON, __LINE__);
...
TEST(CRS, MultiplicationMatrixScalar) {
   ...
   expect_crs_eq(CRS<long double>({{1.3L}}) * static_cast<long>(1L), CRS<long double>({{1.3L}}), LDBL_EPSILON,
                 __LINE__);
   expect_crs_eq(CRS<long double>({{1.3L}}) * static_cast<std::int32_t>(1), CRS<long double>({{1.3L}}), LDBL_EPSILON, __LINE__);
   ...
   expect_crs_eq(CRS<double>({{1.3}}) * static_cast<std::int32_t>(1), CRS<double>({{1.3}}), DBL_EPSILON, __LINE__);
   ...
   expect_crs_eq(CRS<float>({{1.3F}}) * static_cast<std::int32_t>(1), CRS<double>({{1.3F}}), FLT_EPSILON, __LINE__);
   ...
   expect_crs_eq(CRS<long long>({{1LL}}) * static_cast<std::int32_t>(2), CRS<std::int32_t>({{2LL}}), LDBL_EPSILON, __LINE__);
   ...
   expect_crs_eq(CRS<long>({{1L}}) * static_cast<std::int32_t>(2), CRS<std::int32_t>({{2LL}}), LDBL_EPSILON, __LINE__);
   ...
   expect_crs_eq(CRS<std::int32_t>({{1}}) * static_cast<long double>(1.4L), CRS<long double>({{1.4L}}), LDBL_EPSILON, __LINE__);
   expect_crs_eq(CRS<std::int32_t>({{1}}) * static_cast<double>(1.4), CRS<double>({{1.4}}), DBL_EPSILON, __LINE__);
   expect_crs_eq(CRS<std::int32_t>({{1}}) * static_cast<float>(1.4F), CRS<float>({{1.4F}}), FLT_EPSILON, __LINE__);
   expect_crs_eq(CRS<std::int32_t>({{1}}) * static_cast<long long>(2LL), CRS<long long>({{2LL}}), LDBL_EPSILON, __LINE__);
   expect_crs_eq(CRS<std::int32_t>({{1}}) * static_cast<long>(2L), CRS<long>({{2LL}}), LDBL_EPSILON, __LINE__);
   expect_crs_eq(CRS<std::int32_t>({{1}}) * static_cast<std::int32_t>(2), CRS<std::int32_t>({{2LL}}), LDBL_EPSILON, __LINE__);
   expect_crs_eq(CRS<std::int32_t>({{1}}) * static_cast<short>(2), CRS<short>({{2LL}}), LDBL_EPSILON, __LINE__);
   expect_crs_eq(CRS<std::int32_t>({{1}}) * static_cast<char>(2), CRS<char>({{2LL}}), LDBL_EPSILON, __LINE__);
   ...
   expect_crs_eq(CRS<short>({{1}}) * static_cast<std::int32_t>(2), CRS<std::int32_t>({{2LL}}), LDBL_EPSILON, __LINE__);
   ...
   expect_crs_eq(CRS<char>({{1}}) * static_cast<std::int32_t>(2), CRS<std::int32_t>({{2LL}}), LDBL_EPSILON, __LINE__);
...
TEST(CRS, MultiplicationScalarMatrix) {
   ...
   expect_crs_eq(static_cast<long>(1L) * CRS<long double>({{1.3L}}), CRS<long double>({{1.3L}}), LDBL_EPSILON,
                 __LINE__);
   expect_crs_eq(static_cast<std::int32_t>(1) * CRS<long double>({{1.3L}}), CRS<long double>({{1.3L}}), LDBL_EPSILON, __LINE__);
   ...
   expect_crs_eq(static_cast<std::int32_t>(1) * CRS<double>({{1.3}}), CRS<double>({{1.3}}), DBL_EPSILON, __LINE__);
   ...
   expect_crs_eq(static_cast<std::int32_t>(1) * CRS<float>({{1.3F}}), CRS<double>({{1.3F}}), FLT_EPSILON, __LINE__);
   ...
   expect_crs_eq(static_cast<std::int32_t>(2) * CRS<long long>({{1LL}}), CRS<std::int32_t>({{2LL}}), LDBL_EPSILON, __LINE__);
   ...
   expect_crs_eq(static_cast<std::int32_t>(2) * CRS<long>({{1L}}), CRS<std::int32_t>({{2LL}}), LDBL_EPSILON, __LINE__);
   ...
   expect_crs_eq(static_cast<long double>(1.4L) * CRS<std::int32_t>({{1}}), CRS<long double>({{1.4L}}), LDBL_EPSILON, __LINE__);
   expect_crs_eq(static_cast<double>(1.4) * CRS<std::int32_t>({{1}}), CRS<double>({{1.4}}), DBL_EPSILON, __LINE__);
   expect_crs_eq(static_cast<float>(1.4F) * CRS<std::int32_t>({{1}}), CRS<float>({{1.4F}}), FLT_EPSILON, __LINE__);
   expect_crs_eq(static_cast<long long>(2LL) * CRS<std::int32_t>({{1}}), CRS<long long>({{2LL}}), LDBL_EPSILON, __LINE__);
   expect_crs_eq(static_cast<long>(2L) * CRS<std::int32_t>({{1}}), CRS<long>({{2LL}}), LDBL_EPSILON, __LINE__);
   expect_crs_eq(static_cast<std::int32_t>(2) * CRS<std::int32_t>({{1}}), CRS<std::int32_t>({{2LL}}), LDBL_EPSILON, __LINE__);
   expect_crs_eq(static_cast<short>(2) * CRS<std::int32_t>({{1}}), CRS<short>({{2LL}}), LDBL_EPSILON, __LINE__);
   expect_crs_eq(static_cast<char>(2) * CRS<std::int32_t>({{1}}), CRS<char>({{2LL}}), LDBL_EPSILON, __LINE__);
   ...
   expect_crs_eq(static_cast<std::int32_t>(2) * CRS<short>({{1}}), CRS<std::int32_t>({{2LL}}), LDBL_EPSILON, __LINE__);
   ...
   expect_crs_eq(static_cast<std::int32_t>(2) * CRS<char>({{1}}), CRS<std::int32_t>({{2LL}}), LDBL_EPSILON, __LINE__);
...
TEST(CRS, MultiplicationEquality) {
   ...
   EXPECT_TRUE(CRS<long long>({{1LL}}) == CRS<std::int32_t>({{1}}));
   ...
   EXPECT_TRUE(CRS<long>({{1L}}) == CRS<std::int32_t>({{1}}));
   EXPECT_TRUE(CRS<long>({{1L}}) == CRS<short>({{1}}));
   EXPECT_TRUE(CRS<long>({{1L}}) == CRS<char>({{1}}));

   EXPECT_TRUE(CRS<std::int32_t>({{1}}) == CRS<long long>({{1LL}}));
   EXPECT_TRUE(CRS<std::int32_t>({{1}}) == CRS<long>({{1L}}));
   EXPECT_TRUE(CRS<std::int32_t>({{1}}) == CRS<std::int32_t>({{1}}));
   EXPECT_TRUE(CRS<std::int32_t>({{1}}) == CRS<short>({{1}}));
   EXPECT_TRUE(CRS<std::int32_t>({{1}}) == CRS<char>({{1}}));

   EXPECT_TRUE(CRS<short>({{1}}) == CRS<long long>({{1LL}}));
   EXPECT_TRUE(CRS<short>({{1}}) == CRS<long>({{1L}}));
   EXPECT_TRUE(CRS<short>({{1}}) == CRS<std::int32_t>({{1}}));
   ...
   EXPECT_TRUE(CRS<char>({{1}}) == CRS<std::int32_t>({{1}}));
   ...
   EXPECT_FALSE(CRS<long long>({{1LL, 2LL}}) == CRS<std::int32_t>({{1}}));
   ...
   EXPECT_FALSE(CRS<long>({{1L, 2L}}) == CRS<std::int32_t>({{1}}));
   EXPECT_FALSE(CRS<long>({{1L, 2L}}) == CRS<short>({{1}}));
   EXPECT_FALSE(CRS<long>({{1L, 2L}}) == CRS<char>({{1}}));

   EXPECT_FALSE(CRS<std::int32_t>({{1, -1}}) == CRS<long long>({{1LL}}));
   EXPECT_FALSE(CRS<std::int32_t>({{1, -1}}) == CRS<long>({{1L}}));
   EXPECT_FALSE(CRS<std::int32_t>({{1, -1}}) == CRS<std::int32_t>({{1}}));
   EXPECT_FALSE(CRS<std::int32_t>({{1, -1}}) == CRS<short>({{1}}));
   EXPECT_FALSE(CRS<std::int32_t>({{1, -1}}) == CRS<char>({{1}}));

   EXPECT_FALSE(CRS<short>({{1, -1}}) == CRS<long long>({{1LL}}));
   EXPECT_FALSE(CRS<short>({{1, -1}}) == CRS<long>({{1L}}));
   EXPECT_FALSE(CRS<short>({{1, -1}}) == CRS<std::int32_t>({{1}}));
   ...
   EXPECT_FALSE(CRS<char>({{1, -1}}) == CRS<std::int32_t>({{1}}));
   ...
   EXPECT_FALSE(CRS<long long>({{2LL}}) == CRS<std::int32_t>({{1}}));
   ...
   EXPECT_FALSE(CRS<long>({{2L}}) == CRS<std::int32_t>({{1}}));
   EXPECT_FALSE(CRS<long>({{2L}}) == CRS<short>({{1}}));
   EXPECT_FALSE(CRS<long>({{2L}}) == CRS<char>({{1}}));

   EXPECT_FALSE(CRS<std::int32_t>({{2}}) == CRS<long long>({{1LL}}));
   EXPECT_FALSE(CRS<std::int32_t>({{2}}) == CRS<long>({{1L}}));
   EXPECT_FALSE(CRS<std::int32_t>({{2}}) == CRS<std::int32_t>({{1}}));
   EXPECT_FALSE(CRS<std::int32_t>({{2}}) == CRS<short>({{1}}));
   EXPECT_FALSE(CRS<std::int32_t>({{2}}) == CRS<char>({{1}}));

   EXPECT_FALSE(CRS<short>({{2}}) == CRS<long long>({{1LL}}));
   EXPECT_FALSE(CRS<short>({{2}}) == CRS<long>({{1L}}));
   EXPECT_FALSE(CRS<short>({{2}}) == CRS<std::int32_t>({{1}}));
   ...
   EXPECT_FALSE(CRS<char>({{2}}) == CRS<std::int32_t>({{1}}));
