...
void PyBindUtility(py::module &m) {
   ...
   m.def("calculate_fft_magnitude_list", &utility::CalculateFFTMagnitudeList, "array_list"_a, "n"_a, "norm"_a, "power"_a, "num_threads"_a);
   m.def("calculate_fft2_magnitude_list", &utility::CalculateFFT2MagnitudeList, "array_list"_a, "n_x"_a, "n_y"_a, "norm"_a, "power"_a, "num_threads"_a);
}
