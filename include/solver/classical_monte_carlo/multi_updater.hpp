      ...
      for (std::int32_t sweep_count = 0; sweep_count < num_sweeps; sweep_count++) {
         for (std::int32_t i = 0; i < system_size; i++) {
            ...
            if (0 <= new_whole_state && new_whole_state < num_state_1 - 1) {
               const std::int32_t candidate_state = present_state_1 <= new_whole_state ? new_whole_state + 1 : new_whole_state;
               ...
               const std::int32_t candidate_state = present_state_2 <= new_whole_state ? new_whole_state + 1 : new_whole_state;
               ...
               std::int32_t new_state_1 = new_whole_state/(num_state_2 - 1);
               std::int32_t new_state_2 = new_whole_state%(num_state_2 - 1);
