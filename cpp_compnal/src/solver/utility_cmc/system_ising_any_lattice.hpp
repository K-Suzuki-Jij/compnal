...
#ifndef COMPNAL_SOLVER_UTILITY_CMC_SYSTEM_ISING_ANY_LATTICE_HPP_
#define COMPNAL_SOLVER_UTILITY_CMC_SYSTEM_ISING_ANY_LATTICE_HPP_
...
class CMCSystem<model::classical::Ising<lattice::AnyLattice, RealType>>: public CMCBaseIsingSystem {
   
   using ModelType = model::classical::Ising<lattice::AnyLattice, RealType>;
...
template<typename RealType>
CMCSystem(const model::classical::Ising<lattice::AnyLattice, RealType>) -> CMCSystem<model::classical::Ising<lattice::AnyLattice, RealType>>;
...
#endif /* COMPNAL_SOLVER_UTILITY_CMC_SYSTEM_ISING_ANY_LATTICE_HPP_ */
