...
#ifndef COMPNAL_SOLVER_UTILITY_CMC_SYSTEM_ISING_CUBIC_HPP_
#define COMPNAL_SOLVER_UTILITY_CMC_SYSTEM_ISING_CUBIC_HPP_
...
class CMCSystem<model::classical::Ising<lattice::Cubic, RealType>>: public CMCBaseIsingSystem {
   
   using ModelType = model::classical::Ising<lattice::Cubic, RealType>;
...
template<typename RealType>
CMCSystem(const model::classical::Ising<lattice::Cubic, RealType>) -> CMCSystem<model::classical::Ising<lattice::Cubic, RealType>>;
...
#endif /* COMPNAL_SOLVER_UTILITY_CMC_SYSTEM_ISING_CUBIC_HPP_ */
