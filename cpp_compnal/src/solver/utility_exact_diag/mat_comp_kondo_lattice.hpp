...
#ifndef COMPNAL_SOLVER_UTILITY_EXACT_DIAG_MAT_COMP_KONDO_LATTICE_HPP_
#define COMPNAL_SOLVER_UTILITY_EXACT_DIAG_MAT_COMP_KONDO_LATTICE_HPP_
...
#endif /* COMPNAL_SOLVER_UTILITY_EXACT_DIAG_MAT_COMP_KONDO_LATTICE_HPP_ */
